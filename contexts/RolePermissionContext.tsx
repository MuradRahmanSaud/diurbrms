...
const DEFAULT_ROLE_PERMISSIONS: RolePermissions = {
    ...
    moderator: {
        ...
        dashboardAccess: { canViewCourseList: true, canViewSectionList: true, canViewRoomList: true, canViewTeacherList: true, canViewSlotRequirement: true, canAutoAssign: false, canManageVersions: false, canViewSlotUsage: true, canViewMakeupSchedule: true, classMonitoringAccess: 'full', canManageProgramSetup: false, canManageDefaultSlots: false, canManageSemesterSetup: false, canViewSectionTable: true, canCustomizeTheme: false, canDragAndDrop: false, canViewSlotHistory: true, canViewEditableRoutine: true, canViewPublishedRoutine: true, canPublishRoutine: false },
    ...
    'routine-organizer': {
        ...
        roomEditAccess: { canManageRoomManagement: true, canAddBuilding: true, canAddRoom: true, canDeleteRoom: true, canViewRoomDetail: true, canEditAssignToProgram: true, canEditShareWithPrograms: true, canEditDetailsTab: true, canEditSlotsTab: true, canImportRoomData: true, canExportRoomData: true },
        dashboardAccess: { canViewCourseList: true, canViewSectionList: true, canViewRoomList: true, canViewTeacherList: true, canViewSlotRequirement: true, canAutoAssign: true, canManageVersions: true, canViewSlotUsage: true, canViewMakeupSchedule: true, canEditCourseSectionDetails: true, canImportCourseData: true, canExportCourseData: true, classMonitoringAccess: 'full', canManageProgramSetup: true, canManageDefaultSlots: true, canManageSemesterSetup: true, canViewSectionTable: true, canCustomizeTheme: false, canDragAndDrop: true, canViewSlotHistory: true, canViewEditableRoutine: true, canViewPublishedRoutine: true, canPublishRoutine: true },
        programManagementAccess: { canAddProgram: true, canEditProgram: true },
        notificationAccess: { canGetNotification: true, canApproveSlots: true },
    },
    ...
    teacher: {
        ...
        roomEditAccess: { canManageRoomManagement: false, canAddBuilding: false, canAddRoom: false, canDeleteRoom: false, canViewRoomDetail: true, canEditAssignToProgram: false, canEditShareWithPrograms: false, canEditDetailsTab: false, canEditSlotsTab: false },
        dashboardAccess: { canViewCourseList: false, canViewSectionList: false, canViewRoomList: false, canViewTeacherList: true, canViewSlotRequirement: false, canAutoAssign: false, canManageVersions: false, canViewSlotUsage: false, canViewMakeupSchedule: true, classMonitoringAccess: 'own', canManageProgramSetup: false, canManageDefaultSlots: false, canManageSemesterSetup: false, canViewSectionTable: false, canCustomizeTheme: false, canDragAndDrop: false, canViewSlotHistory: true, canViewEditableRoutine: true, canViewPublishedRoutine: true, canPublishRoutine: false },
        programManagementAccess: { canAddProgram: false, canEditProgram: false },
        notificationAccess: { canGetNotification: true, canApproveSlots: false },
    },
    user: {
        ...
        dashboardAccess: { canViewCourseList: false, canViewSectionList: false, canViewRoomList: false, canViewTeacherList: false, canViewSlotRequirement: false, canAutoAssign: false, canManageVersions: false, canViewSlotUsage: false, canViewMakeupSchedule: false, canEditCourseSectionDetails: false, canImportCourseData: false, canExportCourseData: false, classMonitoringAccess: 'none', canManageProgramSetup: false, canManageDefaultSlots: false, canManageSemesterSetup: false, canViewSectionTable: false, canCustomizeTheme: false, canDragAndDrop: false, canViewSlotHistory: false, canViewEditableRoutine: false, canViewPublishedRoutine: true, canPublishRoutine: false },
        programManagementAccess: { canAddProgram: false, canEditProgram: false },
